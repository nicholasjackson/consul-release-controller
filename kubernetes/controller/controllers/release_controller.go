...
func (r *ReleaseReconciler) SetupWithManager(mgr ctrl.Manager) error {
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &consulreleasecontrollerv1.Release{}, deploymentField, func(rawObj client.Object) []string {
...
// Function that determines which Kubernetes deployments that are submitted to the system should trigger a reconcile
// for the controller
// Reconcile will get called everytime the deployment changes, this includes when its status changes
